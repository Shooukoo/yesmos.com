...
function calculateSellingPrice(precioOriginal: number, categoria: string, nombreProducto: string) {
    ...
    if (cat === "TAPAS") { const precioFinal = nombre.includes("iphone") || nombre.includes("ip") ? 900 : 550; return { sellingPrice: precioFinal } }
    const categoriasFijas: Record<string, number> = { "BANDEJAS SIM": 350, LENTES: 350, "CENTRO DE CARGA": 350, "FLEX DE CARGA": 550 }
    if (categoriasFijas[cat]) { return { sellingPrice: categoriasFijas[cat] } }
